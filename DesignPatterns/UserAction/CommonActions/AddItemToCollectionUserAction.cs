...
/// <summary>
/// User action that adds an item to a collection-like property and removes it on undo.
/// </summary>
public sealed class AddItemToCollectionUserAction<TTarget, TItem> : UserActionBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AddItemToCollectionUserAction{TTarget, TItem}"/> class.
    /// </summary>
    public AddItemToCollectionUserAction(
